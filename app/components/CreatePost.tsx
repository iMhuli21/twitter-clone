...
export default function CreatePost({ id, photo }: CreatePostProps) {
  ...
  return (
    <div className="flex flex-col items-start justify-center w-full py-2 px-5 border-b border-gray-800 hover:bg-neutral transition hover:cursor-pointer">
      ...
      <div className="flex items-center justify-between w-full py-2">
        ...
        <button
          disabled={isPending}
          className="btn btn-info text-white rounded-3xl normal-case w-32 md:w-40 disabled:bg-gray-500"
          onClick={sendOutPost}
        >
          Post
        </button>
